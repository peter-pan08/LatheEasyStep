...
def test_parting_tooltips_set_for_de_and_en():
    ...
    widgets = {
        ...
        # finish allowances will be added later in test
        "parting_finish_allow_x": FakeWidget(),
        "parting_finish_allow_z": FakeWidget(),
    }
    ...
    # finish allowances should also receive German tooltips
    assert "Schlichtzuschlag" in widgets["parting_finish_allow_x"]._tooltip
    assert "Schlichtzuschlag" in widgets["parting_finish_allow_z"]._tooltip
    ...
    # finish allowances english
    assert "finish allowance" in widgets["parting_finish_allow_x"]._tooltip.lower()
    assert "finish allowance" in widgets["parting_finish_allow_z"]._tooltip.lower()

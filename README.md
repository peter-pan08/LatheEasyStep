...
- die aktuelle Entwicklungsbasis inkl. Freistich-/Sicherheitsausbau, UI-Teilung, Real-Qt-Regressionen und realen Generatorfixes ist mit `859 passed (Stub-Qt), 102 passed (Real-Qt), 0 skipped` validiert
...
- the current development baseline is validated with `859 passed (Stub-Qt), 102 passed (Real-Qt), 0 skipped`
